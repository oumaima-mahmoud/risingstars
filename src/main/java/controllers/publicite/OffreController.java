...
public class OffreController {
    ...
    private void openAddOffreWindow() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/publicite/add_offre.fxml"));
    ...
    private void openModifyOffreWindow(Offre selectedOffre) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/publicite/modify_offre.fxml"));
            Parent root = loader.load();
