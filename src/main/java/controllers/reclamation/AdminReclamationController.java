...
public class AdminReclamationController {
    ...
    private void ouvrirReponses(ActionEvent event) {
        ...
        if (selectedReclamation != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/reclamation/admineReponse.fxml"));
                Parent root = loader.load();
    ...
    private void showStatistics(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/reclamation/StatisticsView.fxml"));
            Parent root = loader.load();
    ...
    private void openChatbox() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/reclamation/ChatboxView.fxml"));
            Parent root = loader.load();
