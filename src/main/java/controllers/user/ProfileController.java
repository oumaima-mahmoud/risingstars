...
public class ProfileController {
    ...
    private void addAbonnement() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/user/abonnement.fxml"));
    ...
    private void logout() {
        ...
        SceneManager.switchScene((Stage) logoutButton.getScene().getWindow(), "/user/login.fxml");
    }
