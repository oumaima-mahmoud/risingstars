...
public class HomeController {
    ...
    public void goToContactPage() {
        ...
        loadPage("/user/contact.fxml", "Contact Page");
    }

    @FXML
    public void goToRegisterPage() {
        // Logic to go to the Register page
        loadPage("/user/register.fxml", "Register Page");
    }

    @FXML
    public void goToLoginPage() {
        // Logic to go to the Login page
        loadPage("/user/Login.fxml", "Login Page");
    }

    @FXML
    public void goToAbonnements() {
        // Logic to go to the Abonnements page
        loadPage("/user/abonnement.fxml", "Abonnements Page");
    }
